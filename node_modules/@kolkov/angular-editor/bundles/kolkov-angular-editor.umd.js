(function (global, factory) {
     ...
     */
    var AngularEditorService = (function () {
         ...
         */
            function (url) {
                if (!url.includes("http")) {
                    ...
                    var /** @type {?} */ newUrl = '<a href="' + url + '" target="_blank">' + this.selectedText + '</a>';
         ...
         */
            function (color, where) {
                var /** @type {?} */ restored = this.restoreSelection();
                if (restored) {
                    if (where === 'textColor') {
         ...
         */
            function (html) {
                var /** @type {?} */ isHTMLInserted = this._document.execCommand('insertHTML', false, html);
                if (!isHTMLInserted) {
         ...
         */
            function () {
                var /** @type {?} */ slectedText = this.savedSelection.toString();
         ...
         */
            function (file) {
                var /** @type {?} */ uploadData = new FormData();
         ...
         */
            function (customClass) {
                var /** @type {?} */ tagName = customClass.tag ? customClass.tag : 'span';
                var /** @type {?} */ newTag = '<' + tagName + ' class="' + customClass.class + '">' + this.selectedText + '</' + tagName + '>';
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var AngularEditorComponent = (function () {
         ...
         */
            function (isDisabled) {
                var /** @type {?} */ div = this.textArea.nativeElement;
                var /** @type {?} */ action = isDisabled ? 'addClass' : 'removeClass';
         ...
         */
            function (bToSource) {
                var /** @type {?} */ oContent;
                var /** @type {?} */ editableElement = this.textArea.nativeElement;
                if (bToSource) {
                    oContent = this._document.createTextNode(editableElement.innerHTML);
                    editableElement.innerHTML = '';
                    var /** @type {?} */ oPre = this._document.createElement('pre');
                    oPre.setAttribute("style", "margin: 0; outline: none;");
                    var /** @type {?} */ oCode = this._document.createElement('code');
         ...
         */
            function () {
                ...
                var /** @type {?} */ userSelection;
                if (window.getSelection) {
                    userSelection = window.getSelection();
                }
                var /** @type {?} */ a = userSelection.focusNode;
                var /** @type {?} */ els = [];
                while (a && a.id !== 'editor') {
                    els.unshift(a);
                    a = a.parentNode;
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var AngularEditorToolbarComponent = (function () {
         ...
         */
            function () {
                ...
                this.buttons.forEach(function (e) {
                    var /** @type {?} */ result = _this._document.queryCommandState(e);
                    var /** @type {?} */ elementById = _this._document.getElementById(e + '-' + _this.id);
                    if (result) {
         ...
         */
            function (nodes) {
                ...
                this.select.forEach(function (y) {
                    var /** @type {?} */ node = nodes.find(function (x) { return x.nodeName === y; });
                ...
                this.customClasses.forEach(function (y, index) {
                    var /** @type {?} */ node = nodes.find(function (x) {
                ...
                Object.keys(this.tagMap).map(function (e) {
                    var /** @type {?} */ elementById = _this._document.getElementById(_this.tagMap[e] + '-' + _this.id);
                    var /** @type {?} */ node = nodes.find(function (x) { return x.nodeName === e; });
         ...
         */
            function () {
                var /** @type {?} */ url = prompt("Insert URL link", 'http:\/\/');
                if (url && url !== '' && url !== 'http://') {
         ...
         */
            function (m) {
                var /** @type {?} */ toggleEditorModeButton = this._document.getElementById("toggleEditorMode" + '-' + this.id);
                if (m) {
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var AngularEditorModule = (function () {
